...
- (void)cellWillAppear{
    ...
    if (![NSString nb_isEmpty:self.detailText]) {
    ...
    if (self.normalBackgroundImage) {
        self.normalBackgroundImageView.backgroundColor = COLOR_SYSTEM_CLEAR;
        [self addBackgroundImage];
    }
    if (self.highlightedBackgroundImage) {
        self.highlightedBackgroundView.backgroundColor = COLOR_SYSTEM_CLEAR;
