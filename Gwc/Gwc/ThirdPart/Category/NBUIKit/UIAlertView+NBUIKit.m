...
@implementation UIAlertView (NBUIKit)
...
- (void)showWithHandler:(UIAlertViewHandler)handler {
    ...
    objc_setAssociatedObject(self, &kHandlerKey, handler, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    UIAlertViewHandler completionHandler=nil;
